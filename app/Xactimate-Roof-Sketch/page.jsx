...
>
 ...
 className="ri-home-line mr-3"></i>
    ...
    <div className="min-h-screen bg-black text-orange-300">
      <Head>
        <title>Master Your Roof Estimates: The Ultimate Guide to Xactimate Roof Sketch</title>
        <meta
          name="description"
          content="Master Xactimate Roof Sketch with this ultimate guide for roofing contractors. Learn to create accurate roof estimates, integrate insight reports, and sketch flat roofs with precision."
        />
        <link
          rel="stylesheet"
