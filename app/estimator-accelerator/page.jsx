        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-[#070707] to-[#0b0b0b] p-6 rounded-xl border border-orange-900/40 hover:border-orange-600/50 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="bg-[#070707] p-6 rounded-xl border border-orange-900/40 hover:border-orange-600/50 transition-all duration-300 shadow-lg">
