          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Eliminated Errors:</strong> Avoid costly mistakes in hips, valleys, or pitch.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span><strong>Faster Approvals:</strong> Objective data reduces disputes with insurers.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span><strong>Enhanced Trust:</strong> Impress homeowners with cutting-edge technology.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>High-Resolution Imagery:</strong> Clear overhead photos from multiple angles.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-6h6v6M3 3h18v18H3V3z" />
                </svg>
                <span><strong>CAD-like Diagrams:</strong> Precise line drawings of roof planes and features.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span><strong>Measurements Summary:</strong> Detailed PDF with dimensions and slopes.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                </svg>
                <span><strong>3D Model:</strong> Interactive model for viewing and rotating.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Order Your Report:</strong> Enter the property address to receive a PDF and data files.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2" />
                </svg>
                <span><strong>Import into Xactimate:</strong> Use the Sketch tab to import .CRX or .HIP files.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span><strong>Calibrate Scale:</strong> Set the scale using a known dimension from the PDF.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Trace the Planes:</strong> Use "Add Surface" to outline roof planes for accurate square footage.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span><strong>Define Features:</strong> Add hips, valleys, and ridges for material and labor calculations.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                </svg>
                <span><strong>Assign Properties:</strong> Set pitch, surface type, and waste factor for precision.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Sense Check:</strong> Verify total square footage against home size and PDF data.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                </svg>
                <span><strong>Layering for Dormers:</strong> Use "Add Level" and "Add Layer" for complex roofs.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Material Quantities:</strong> Shingles, ridge caps, and underlayment calculated automatically.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span><strong>Backup Documentation:</strong> Attach the PDF to support your claim.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <ul className="list-disc pl-6 space-y-2 text-orange-200">
              <li className="flex items-start">
                ...
                <span><strong>Eliminate Mistakes:</strong> Avoid under-scoping projects.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span><strong>Win More Bids:</strong> Impress with professional technology.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span><strong>Faster Payments:</strong> Speed up claims with accurate data.</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-orange-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-6h6v6M3 3h18v18H3V3z" />
                </svg>
                <span><strong>Enhanced Safety:</strong> Reduce the need for rooftop measurements.</span>
              </li>
            </ul>
          </div>
        </section>
